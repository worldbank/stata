...
Commands still in development can be found in and submitted to the [dev](https://github.com/worldbank/stata/tree/master/dev) directory; more polished commands are moved to [src](https://github.com/worldbank/stata/tree/master/src) after review by the team. Commands in [src](https://github.com/worldbank/stata/tree/master/src) are surfaced on this [landing page](http://worldbank.github.io/stata/) and made visible to [`wb_git_install`](https://github.com/worldbank/stata/tree/master/wb_git_install) after review.
