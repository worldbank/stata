...
{* Sep 8th 2015}
{hline}
Help for {hi:weightTab}
{hline}

{title:Description}

{p}{cmd:weightTab} produces xlsx sheets and/or bar graphs with weighted cross-group comparisons.

{title:Syntax}

{p 2 4}{cmd:weightTab} {help varlist} [{help if}] [{help in}] [{help using}] [{help weight}], {opth over(varlist)} [{it:options}]
